...
//                    mContext.startActivity(intent);
    ...
    public void parseJson(String data, boolean isTokenExpired) {
        try {
            ...
            try {
                ...
                if (!common.getStatusCode().equals(Constants.SUCCESS)) {
            ...
            if (isTokenExpired) {
                ...
                switch (this.mDataTag) {
                    ...
                    case Constants.TASK_LOGIN: //This is for get archived list
                        ...
                        break;
                    case Constants.TASK_LOGIN_WITH_PASSWORD: //This is for get archived list
                        ...
                        break;
                    case Constants.TASK_LOGIN_WITH_OTP: //This is for get archived list
                        ...
                        break;
                    case Constants.TASK_SIGN_UP: //This is for get sign-up
    ...
    private void loginRequest() {
        ...
        loginRequestModel.setEmailId(AppPreferencesManager.getString(AppPreferencesManager.PREFERENCES_KEY.EMAIL, mContext));
        loginRequestModel.setPassword(AppPreferencesManager.getString(AppPreferencesManager.PREFERENCES_KEY.PASSWORD, mContext));
        if (!(Constants.BLANK.equalsIgnoreCase(loginRequestModel.getEmailId()) &&
